 ...
 */
Auth0.prototype._buildPopupWindow = function (options) {
  ...
  var popupOptions = stringifyPopupSettings(xtend(
                          ...
                          (options.popupOptions || {})));
  this._current_popup = window.open('about:blank', 'auth0_signup_popup',popupOptions);
