...
Auth0.prototype.loginPhonegap = function (options, callback) {
  ...
  var query = this._buildAuthorizeQueryString([
    ...
    function stopHandler(event) {
      if (answered) { return; }
      var result = self.parseHash(event.url);
      ...
      callback(new Error(result.err || 'Something went wrong'), null, null, null, null);
      anwered = true;
      return ref.close();
    }
    ...
    function exitHandler() {
      ...
      ref.removeEventListener('loadstop', stopHandler);
      ref.removeEventListener('exit', exitHandler);
    }

    ref.addEventListener('loaderror', errorHandler);
    ref.addEventListener('loadstop', stopHandler);
