...
Auth0.prototype.loginPhonegap = function (options, callback) {
  if (this._shouldAuthenticateWithCordovaPlugin(options.connection)) {
    this._socialLogin(options, callback);
    return;
  }
...
Auth0.prototype._socialLogin = function(options, callback) {
...
Auth0.prototype._facebookLogin = function(scopes, callback) {
