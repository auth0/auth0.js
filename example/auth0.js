...
Auth0.prototype.loginWithPopup = function(options, callback) {
  ...
  function popupReadyCheck() {
    ...
    if (!(popup.top || popup.window)) {
      ...
      popup = null;
      callback({error: 'User closed the popup window'}, null, null, null, null);
      return;
    }
    ...
    if (hash.length) {
      ...
      if (result) {
        if (result.id_token) {
          ...
          callback(result, null, null, null, null);
